...
def make_authcheck_node(node_id: str) -> dict:
    return {
        "parameters": {"jsCode": AUTH_CHECK_CODE},
...
def main():
    ...
    search_nodes = [
        by_name["PrepSearch"],
        by_name["SearchRequest"],
        by_name["FormatSearch"],
        by_name["RespondSearch"],
    ]
    search_conns = {
    ...
    upload_nodes = [
        ...
        by_name["CreateEmpty"],
        by_name["PrepContent"],
        by_name["UpdateContent"],
        by_name["FormatUpload"],
        by_name["RespondUpload"],
    ]
    upload_conns = {
    ...
    # ---- download ----
    download_nodes = [
        by_name["PrepDownload"],
        by_name["DownloadRequest"],
        by_name["FormatDownload"],
        by_name["RespondDownload"],
    ]
    download_conns = {
    ...
    mkdir_nodes = [
        by_name["PrepMkdir"],
        by_name["MkdirRequest"],
        by_name["FormatMkdir"],
        by_name["RespondMkdir"],
    ]
    mkdir_conns = {
    ...
    delete_nodes = [
        by_name["PrepDelete"],
        by_name["DeleteRequest"],
        by_name["FormatDelete"],
        by_name["RespondDelete"],
    ]
    delete_conns = {
    ...
    rename_nodes = [
        by_name["PrepRename"],
        by_name["RenameRequest"],
        by_name["FormatRename"],
        by_name["RespondRename"],
    ]
    rename_conns = {
    ...
    share_nodes = [
        by_name["PrepShare"],
        by_name["ShareRequest"],
        by_name["FormatShare"],
        by_name["RespondShare"],
    ]
    share_conns = {
